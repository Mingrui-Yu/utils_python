...
MANO_LINE_PAIRS = [[0, 1], [0, 5], [0, 17], [5, 17], 
                    [1, 2], [2, 3], [3, 4],
                    [5, 6], [6, 7], [7, 8],
                    [9, 10], [10, 11], [11, 12],
                    [13, 14], [14, 15], [15, 16],
...
def estimate_wrist_pose_from_hand_points(keypoints_3d: np.ndarray, 
    ...
    rot_mano = rot @ OPERATOR2MANO_RIGHT if hand_type == "right" else rot @ OPERATOR2MANO_LEFT
